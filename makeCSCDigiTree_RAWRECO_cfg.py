...
options.register ('fileN', 0, VarParsing.VarParsing.multiplicity.singleton, VarParsing.VarParsing.varType.int, "First file in the list to process")
options.fileN= '168'
...
process.source = cms.Source ("PoolSource",
        fileNames = cms.untracked.vstring(fileNames[fN*10:fN*10+10])#,
...
process.MakeNtuple = cms.EDAnalyzer("CSCPatterns",
        NtupleFileName       = cms.untracked.string('trees/CSCDigiTree%i.root'%fN),
